@echo off
REM ============================================================================
REM Build Zgine Editor with Nuklear Backend
REM ============================================================================
setlocal enabledelayedexpansion

echo.
echo ================================================
echo    Zgine Editor (Nuklear) Builder
echo ================================================
echo.
...
REM ============================================
echo [5/6] Configuring Zgine Editor with Nuklear Backend (Preset: %CMAKE_PRESET%)...

if exist "build\%CMAKE_PRESET%\CMakeCache.txt" del /f /q "build\%CMAKE_PRESET%\CMakeCache.txt"

cmake --preset=%CMAKE_PRESET% -DZGINE_USE_PCH=%ZGINE_USE_PCH% -DZGINE_BUILD_SANDBOX=OFF -DZGINE_BUILD_EDITOR=ON -DZGINE_BUILD_TESTS=OFF -DZGINE_GUI_NUKLEAR=ON
if errorlevel 1 (
...
echo.
echo ================================================
echo    Nuklear Editor Build Complete
echo ================================================
