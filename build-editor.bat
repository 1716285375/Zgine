@echo off
REM ============================================================================
REM Build ZgineRuntime + ZgineEditor  ->  build-vs2022
REM Usage: build-editor.bat [debug|release]
REM ============================================================================
setlocal enabledelayedexpansion

echo.
echo ================================================
echo    Zgine Editor Builder  (build-vs2022)
echo ================================================
echo.
...
REM --- Build ---
echo [5/5] Building ZgineRuntime + ZgineEditor...
cmake --build build-vs2022 --config %BUILD_TYPE% --parallel 8
if errorlevel 1 (echo Build FAILED! & pause & exit /b 1)

echo.
echo ================================================
echo    Editor Build Complete  [%BUILD_TYPE%]
echo ================================================
set "EXE=build-vs2022\bin\%BUILD_TYPE%\ZgineEditor.exe"
if not exist "%EXE%" set "EXE=build-vs2022\bin\ZgineEditor.exe"
if exist "%EXE%" (
    echo    Executable: %EXE%
