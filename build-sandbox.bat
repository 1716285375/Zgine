@echo off
REM ============================================================================
REM Build ZgineRuntime + ZgineSandbox
REM ============================================================================
setlocal enabledelayedexpansion

echo.
echo ================================================
echo    Zgine Sandbox Builder
echo ================================================
echo.
...
REM ============================================
echo [5/6] Configuring Zgine (Runtime + Sandbox) with preset: %CMAKE_PRESET% (PCH=%ZGINE_USE_PCH%)...

if exist "build\%CMAKE_PRESET%\CMakeCache.txt" del /f /q "build\%CMAKE_PRESET%\CMakeCache.txt"

cmake --preset=%CMAKE_PRESET% -DZGINE_USE_PCH=%ZGINE_USE_PCH% -DZGINE_BUILD_SANDBOX=ON -DZGINE_BUILD_EDITOR=OFF -DZGINE_BUILD_TESTS=OFF
if errorlevel 1 (
