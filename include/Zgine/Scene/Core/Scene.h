...
#include <Zgine/Scene/Systems/SystemManager.h>
#include <memory>
...
/**
 * @brief Scene represents a collection of entities and systems (Model in MVVM)
 *
 * Scene manages the game world state without UI concerns.
