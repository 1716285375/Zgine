...
#include <Zgine/Scene/Serialization/IComponentSerializer.h>
...
public:
    std::string GetComponentTypeName() const override { return "Transform"; }
...
public:
    std::string GetComponentTypeName() const override { return "Primitive"; }
    void Serialize(const Entity& entity, nlohmann::json& out) const override;
    bool Deserialize(const nlohmann::json& data, Entity& entity) const override;
    bool HasComponent(const Entity& entity) const override;
};
...
public:
    std::string GetComponentTypeName() const override { return "PBRMaterial"; }
    void Serialize(const Entity& entity, nlohmann::json& out) const override;
    bool Deserialize(const nlohmann::json& data, Entity& entity) const override;
    bool HasComponent(const Entity& entity) const override;
};
...
public:
    ...
    public:
        std::string GetComponentTypeName() const override { return "DirectionalLight"; }
        void Serialize(const Entity& entity, nlohmann::json& out) const override;
        bool Deserialize(const nlohmann::json& data, Entity& entity) const override;
        bool HasComponent(const Entity& entity) const override;
    };
    ...
    public:
        std::string GetComponentTypeName() const override { return "PointLight"; }
        void Serialize(const Entity& entity, nlohmann::json& out) const override;
        bool Deserialize(const nlohmann::json& data, Entity& entity) const override;
        bool HasComponent(const Entity& entity) const override;
    };
    ...
    public:
        std::string GetComponentTypeName() const override { return "SpotLight"; }
        void Serialize(const Entity& entity, nlohmann::json& out) const override;
        bool Deserialize(const nlohmann::json& data, Entity& entity) const override;
        bool HasComponent(const Entity& entity) const override;
    };
